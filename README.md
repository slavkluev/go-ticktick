...
[![Go Reference](https://pkg.go.dev/badge/github.com/slavkluev/go-ticktick/v1.svg)](https://pkg.go.dev/github.com/slavkluev/go-ticktick/v1)
...
```bash
go get github.com/slavkluev/go-ticktick/v1
```
